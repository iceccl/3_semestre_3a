  ...
  paths: {
    ...
    "/perguntas/{id_pergunta}": {
        put: {
            ...
            description: 'Atualiza todos os dados de uma pergunta existente, é necessário enviar todos os campos',
            parameters: [
                {
                    name: "id_pergunta",
                    in: "path",
   ...
   components: {
      ...
      schemas: {
        ...
        Listar_Perguntas: {
            ...
            resposta: { type: "string", example: "O resultado dessa operação é 2"},
        ...
        Atualizar_Pergunta: {
            type: 'object',
            required: ["mensagem", "modo_anonimo", "data_envio", "resposta", "data_resposta"],
            properties: {
            id: { type: "integer", example: 1 },
            mensagem: { type: "string", example: "Como calculo 1 + 1?" },
            modo_anonimo: { type: "boolean", example: false},
